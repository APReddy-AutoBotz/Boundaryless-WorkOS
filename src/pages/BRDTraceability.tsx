...
const rows: TraceabilityRow[] = [
  ...
  },
  {
    ...
    deliveryStatus: 'Partial',
    uiStatus: 'Available',
    apiDataStatus: 'Notification events, templates, preferences, delivery attempts, in-app inbox, and mock delivery logging exist.',
    nextAction: 'Add SMTP/Graph adapters, Teams provider credentials, template variable rendering, and browser UAT evidence.',
  },
  {
